...
rubygem_d &> /dev/null
termux-wake-lock;
if [ -e $PREFIX/share/figlet/memesbachha.flf ]; then
	echo -e "\e[1;34m[*] \033[memesbachha.flf figlet font is present\033[0m";
	sleep 4
else
wget https://raw.githubusercontent.com/memesbachha/memesbachha/master/memesbachha.flf &> /dev/null;
sleep 3
cp memesbachha.flf $PREFIX/share/figlet/memesbachha.flf;
...
clear;
echo -e "\033[31m$(figlet -f MEMESBACHHA "T- Header")\e[0m"
echo -e "\e[1;32m
+----------------------------------*/
MEMESBHHA : (\e[33m14.4.2021\e[32m)
